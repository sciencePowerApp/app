...
public class NGeqqOBox extends OBox{

	private var k:Number = 0.04;
	private var wl:Number = 1;

	public function	NGeqqOBox(parentBox:Box):void{
		super(parentBox);
	}
	...
	override public function draw(graph:MovieClip):void{
		...
		graph.graphics.moveTo(finalBounds.x+finalBounds.width*0.2, finalBounds.y + finalBounds.height*0.15);
		graph.graphics.lineTo(finalBounds.x+finalBounds.width*0.8, finalBounds.y + finalBounds.height*0.35);
		
		graph.graphics.moveTo(finalBounds.x+finalBounds.width*0.2, finalBounds.y + finalBounds.height*0.55);
		graph.graphics.lineTo(finalBounds.x+finalBounds.width*0.8, finalBounds.y + finalBounds.height*0.35);
