...
public class NLessOBox extends OBox{

	private var k:Number = 0.03;
	private var wl:Number = 1;

	public function	NLessOBox(parentBox:Box):void{
		super(parentBox);
	}
	...
	override public function draw(graph:MovieClip):void{
		...
		graph.graphics.moveTo(finalBounds.x+finalBounds.width*0.25, finalBounds.y + finalBounds.height*0.5);
		graph.graphics.lineTo(finalBounds.x+finalBounds.width*0.75, finalBounds.y + finalBounds.height*0.65);
		
		graph.graphics.moveTo(finalBounds.x+finalBounds.width*0.25, finalBounds.y + finalBounds.height*0.5);
		graph.graphics.lineTo(finalBounds.x+finalBounds.width*0.75, finalBounds.y + finalBounds.height*0.35);
