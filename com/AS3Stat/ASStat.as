package com.AS3Stat
{
	...
	dynamic public  class ASStat extends Proxy  
	{
		...
		protected function workOn5(name:*,fun:*):*
		{
			  
			  if(name=='alter'){
				 
			      ASStat[String(name)](_array,fun);
			  }else if(name=='map')
			  {
				  var tmpArray:Array = _array;
				  
				  return  ASStat[String(name)](tmpArray,fun);
			  }
	   ...
	   public static function seq(min:Number, max:Number, length:uint, func:*=null):Array
		...
		public static function create(rows:*, cols:*=null, func:*=null):*
		{
